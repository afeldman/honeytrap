...
use honeytrap_deception::{DeceptionSystem, Connection};
use std::sync::Arc;
...
impl Router {
    ...
    pub async fn handle_connection(
        ...
        tracing::debug!("📊 Session {} created for {}", session.id, session.peer_addr);
    ...
    async fn forward_to_backend(
        ...
        // Für jetzt: Connection einfach schließen
        drop(connection);
